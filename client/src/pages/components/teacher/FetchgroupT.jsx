            ...
            >
              <div className="bg-white p-6 rounded-lg shadow-md transition-transform transform hover:scale-105 h-full sm:h-100p sm:w-100p">
                ...
                <p className="text-gray-700 mb-1">
                  <strong className="font-semibold">Group ID:</strong>{' '}
                  {group.groupId}
                </p>
                ...
                <p className="text-gray-700 mb-1">
                  ...
                  {Array.isArray(group.groupMembers) && group.groupMembers.length > 0
                    ? group.groupMembers.slice(0, 2).join(', ') + (group.groupMembers.length > 2 ? '...' : '')
                    : 'N/A'}
                </p>

                <p className="text-gray-700 mb-1">
                  <strong className="font-semibold">Group Leader:</strong>{' '}
                  {group.groupLeader || 'N/A'}
                </p>

                <p className="text-gray-700 mb-1">
                  <strong className="font-semibold">Guide Name:</strong>{' '}
                  {group.guideName || 'N/A'}
                </p>
