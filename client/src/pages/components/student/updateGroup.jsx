...
const UpdateGroup = async (groupid, projectname, projecttechnology, projectinfo,photos,ppt,report,tags,branch) => {
  try {
    ...
    const response = await axios.post('https://v-ideass-1.onrender.com/student/update-group', data, {
      headers: {
