...
const GenerateReport = () => {
  ...
  return (
    ...
    <div className="sm:hover:bg-blue-600 sm:font-normal sm:justify-start flex items-center justify-center md: hover:bg-blue-950 lg:hover:bg-blue-950 font-extrabold  h-full w-full cursor-pointer">
      ...
      {loading && (
        <div className="absolute top-full mt-2 left-0 right-0 flex items-center justify-center gap-2 bg-white border border-yellow-500 text-yellow-800 px-4 py-2 rounded-xl shadow-lg font-medium animate-pulse">
        <svg
